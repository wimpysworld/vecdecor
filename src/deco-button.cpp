    ...
    bool active, bool maximized)
{
      ...
      public:
        ...
        void draw_texture(button_texture_slot_t slot, double alpha) override
        {
            ...
            data.pass->custom_gles_subpass(data.target, [&]
            {
                ...
                {
                    wf::gles::render_target_logic_scissor(
                        data.target, wlr_box_from_pixman_box(box));
                    OpenGL::draw_cached();
                }
            });
            OpenGL::clear_cached();
    ...
    render(backend, {button_geometry.width, button_geometry.height}, active, maximized);
}
}
}
